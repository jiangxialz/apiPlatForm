...
var $this=$(this);
var op={html5Upload:false,skin:'vista',tools:$this.attr("tools")||'full',sourceMode:$this.attr("sourceMode")||false};
...
return false;}};})(jQuery);(function($){
$.pdialog={
_op:{height:400,width:600,minH:40,minW:50,total:20,max:false,mask:false,resizable:true,drawable:true,maxable:true,minable:true,fresh:true},
_current:null,
_zIndex:42,
getCurrent:function(){
...
width:$this.attr('width')||800,height:$this.attr('height')||400,
